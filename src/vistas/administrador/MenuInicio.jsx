...
const menuItems = [
  { name: "Programación", img: programacionImg, route: "/MenuA/ProgramacionA" },
  { name: "Invernaderos", img: inver, route: "/MenuA/PanelInvA" },
  { name: "Estadísticas", img: Estadist, route: "/MenuA/Estadisticas" },
  { name: "Agenda", img: Agend, route: "/MenuA/BlocA" },
  { name: "Configuraciones", img: Config, route: "/MenuA/ConfigAdmin" },
];
